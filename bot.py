...
async def handle_photo_analysis(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        **مطلوب منك:**
        ...
        14. سيتم أخذ توقعات بعد تحليل بعد ثواني من إرسال تحليل 
        15. توقعات ناحجة جدآ وعدم وجود أي توقع غير ناجح أو غير متأكد منه
        16. تحديد صحيح لجميع توقعات مع ذكاء القوي و الخارق
        ...
        **التنسيق المطلوب للإجابة:**
        ...
        توقع الإتجاه: ( صعود عالي ⬆️⬆️ / صعود منخفض ⬆️⬇️ / صعود متوسط ⬆️➡️ / نزول مرتفع ⬇️⬆️ / نزول منخفض ⬇️⬇️/ نزول متوسط ⬇️➡️  )
